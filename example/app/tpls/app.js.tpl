(function(document) {
  ...
  function setI18n() {
    if (window.I18nMsg) {
      ...
      window.I18nMsg.url = '##i18_messages##locales';
    }
  }
  ...
  function loadElements() {
    ...
    bundle.rel = 'import';
    bundle.href = '##remote_url##components/components.html';
  ...
  function loadWebComponentPolyfill(cb) {
    ...
    polyfill.src = '##remote_url##components/webcomponentsjs/webcomponents-lite.min.js';
  ...
  /* document.querySelector('#swManagement').displayInstalledToast = function() {
    if (!window.Polymer.dom(document).querySelector('platinum-sw-cache').disabled) {
      window.Polymer.dom(document).querySelector('#caching-complete').show();
    }
  };
  */
